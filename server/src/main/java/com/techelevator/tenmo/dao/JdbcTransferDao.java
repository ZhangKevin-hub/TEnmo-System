...
public class JdbcTransferDao implements TransferDao{
    ...
    public void transfer(Account sendingAccount, Account receivingAccount, BigDecimal transfer_amount) {
        String sql = "UPDATE account " +
                     ...
                     "VALUES (Default, ?, ?, ?);";
        try {
            jdbcTemplate.update(sql, transfer_amount, sendingAccount.getAccount_id(), transfer_amount,
                    receivingAccount.getAccount_id(), sendingAccount.getAccount_id(), receivingAccount.getAccount_id(), transfer_amount);
    ...
    public void respondToTransferRequest(int transferId, Account sendingAccount, Account receivingAccount, BigDecimal transferAmount, boolean approved) {
        ...
        try {
            if (approved) {
                jdbcTemplate.update(sql, transferAmount, sendingAccount.getAccount_id(), transferAmount,
                        receivingAccount.getAccount_id(), transferId);
            } else {
