...
X1. **[COMPLETE]** As a user of the system, I need to be able to register myself with a username and password.
X   1. The ability to register has been provided in your starter code.
X2. **[COMPLETE]** As a user of the system, I need to be able to log in using my registered username and password.
X   1. Logging in returns an Authentication Token. I need to include this token with all my subsequent interactions with the system outside of registering and logging in.
X   2. The ability to log in has been provided in your starter code.
X   3. User ids start at 1001.
X 3. As a user, when I register a new account is created for me.
X   1. The new account has an initial balance of $1000.
X   2. Account ids start at 2001.
X 4. As an authenticated user of the system, I need to be able to see my Account Balance.
...
M   2. I must not be allowed to send money to myself.
M   3. A transfer includes the User IDs of the from and to users and the amount of TE Bucks.
M   4. The receiver's account balance is increased by the amount of the transfer.
M   5. The sender's account balance is decreased by the amount of the transfer.
   6. I can't send more TE Bucks than I have in my account.
X   7. I can't send a zero or negative amount.
   8. A Sending Transfer has an initial status of *Approved*.
X   9. Transfer ids start at 3001.
